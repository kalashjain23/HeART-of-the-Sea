    ...
    for event in pygame.event.get():
        ...
        if game_active:
            if event.type == obstacle_timer:
                if randint(0,2): obstacle_rect_list.append(kraken.get_rect(topleft = (randint(700, 950), 355)))
                else: obstacle_rect_list.append(fly.get_rect(topleft = (randint(700, 950), 275)))
        else:
